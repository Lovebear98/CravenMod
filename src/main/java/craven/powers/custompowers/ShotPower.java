...
public class ShotPower extends BasePower implements CloneablePowerInterface {
    public static final String POWER_ID = makeID(ShotPower.class.getSimpleName());
    ...
    public ShotPower(AbstractCreature owner) {
        this(owner, 1);
    }
    public ShotPower(AbstractCreature owner, int amount) {
    ...
    public AbstractPower makeCopy() {
        return new ShotPower(owner, amount);
    }
}