...
public abstract class AbstractHungryCard extends BaseCard {
    ...
    public AbstractHungryCard(String ID, CardStats info) {
        super(ID, info);
    ...
    public AbstractCard makeStatEquivalentCopy() {
        ...
        if (card instanceof AbstractHungryCard) {
            ...
            ((AbstractHungryCard) card).secondMagicCanUpgrade = this.secondMagicCanUpgrade;
            ///Pass along whether it's upgraded
            ((AbstractHungryCard) card).secondMagicUpgraded = this.secondMagicUpgraded;
            ///How much it upgrades by
            ((AbstractHungryCard) card).secondMagicUpgrade = this.secondMagicUpgrade;
            ///Its base amount
            ((AbstractHungryCard) card).baseSecondMagic = this.baseSecondMagic;
            ///And its current amount
            ((AbstractHungryCard) card).secondMagic = this.secondMagic;
        }
