...
import coyotle.cards.starter.Defend;
import coyotle.cards.starter.Mutate;
import coyotle.cards.starter.StarfireTotemist;
import coyotle.cards.starter.Strike;
import coyotle.relics.BrightmoonBrave;

import java.util.ArrayList;
import java.util.List;

import static coyotle.CoyotleMod.characterPath;
import static coyotle.CoyotleMod.makeID;
import static coyotle.util.otherutil.ImageManager.EndBackground;
import static coyotle.util.otherutil.SoundManager.COYOTLESHARDSOUNDKEY;
import static coyotle.util.otherutil.SoundManager.PROPHECYSOUNDKEY;

public class CoyotleCharacter extends CustomPlayer {
    //Stats
    ...
    //Strings
    private static final String ID = makeID(CoyotleCharacter.class.getSimpleName()); //This should match whatever you have in the CharacterStrings.json file
    ...
    public static class Meta {
        ...
        @SpireEnum
        public static PlayerClass PROPHECY_CHARACTER;
        @SpireEnum(name = "Dreamsmoke White") // These two MUST match. Change it to something unique for your character.
        public static AbstractCard.CardColor CARD_COLOR;
        @SpireEnum(name = "Dreamsmoke White") @SuppressWarnings("unused")
        ...
        private static final Color cardColor = new Color(225f/255f, 231f/255f, 33f/255f, 1f);
        ...
        public static void registerCharacter() {
            BaseMod.addCharacter(new CoyotleCharacter(), CHAR_SELECT_BUTTON, CHAR_SELECT_PORTRAIT);
        }
    }
    ...
    public List<CutscenePanel> getCutscenePanels() {
        ...
        panels.add(new CutscenePanel("coyotle/images/scenes/Scene1.png", PROPHECYSOUNDKEY));
        panels.add(new CutscenePanel("coyotle/images/scenes/Scene2.png"));
        panels.add(new CutscenePanel("coyotle/images/scenes/Scene3.png", COYOTLESHARDSOUNDKEY));
        return panels;
    }
    ...
    public CoyotleCharacter() {
        super(getNames()[0], Meta.PROPHECY_CHARACTER,
                new CoyotleEnergyOrb(), //Energy Orb
                new SpineAnimation(characterPath("animation/Coyotle.atlas"), characterPath("animation/Coyotle.json"), 1.45f)); //Animation
        AnimationState.TrackEntry e = state.setAnimation(0, "Idle", true);
        AnimationState.TrackEntry e2 = state.setAnimation(1, "MoonGlowCycle", true);
    ...
    public ArrayList<String> getStartingDeck() {
        ...
        retVal.add(Strike.ID);
        retVal.add(Strike.ID);
        retVal.add(StarfireTotemist.ID);
    ...
    public int getAscensionMaxHPLoss() {
        return 11; //Max hp reduction at ascension 14+
    }
    ...
    public void doCharSelectScreenSelectEffect() {
        ...
        CardCrawlGame.sound.playA(COYOTLESHARDSOUNDKEY, MathUtils.random(-0.2F, 0.2F));
