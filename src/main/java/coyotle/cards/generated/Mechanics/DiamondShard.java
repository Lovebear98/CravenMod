...
@NoCompendium
public class DiamondShard extends AbstractShardCard {
    public static final String[] EXTENDED_DESCRIPTION = CardStrings.getMockCardString().EXTENDED_DESCRIPTION;
    public static final String ID = makeID(DiamondShard.class.getSimpleName());
    ...
    public AbstractCard makeCopy() {
        AbstractShardCard c = new DiamondShard();
        c.BloodNum = BloodNum;
