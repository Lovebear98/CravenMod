...
@NoCompendium
public class BloodShard extends AbstractShardCard {
    public static final String[] EXTENDED_DESCRIPTION = CardStrings.getMockCardString().EXTENDED_DESCRIPTION;
    public static final String ID = makeID(BloodShard.class.getSimpleName());
    ...
    public AbstractCard makeCopy() {
        AbstractShardCard c = new BloodShard();
        c.BloodNum = BloodNum;
