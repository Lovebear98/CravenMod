...
@NoCompendium
public class SapphireShard extends AbstractShardCard {
    public static final String[] EXTENDED_DESCRIPTION = CardStrings.getMockCardString().EXTENDED_DESCRIPTION;
    public static final String ID = makeID(SapphireShard.class.getSimpleName());
    ...
    public AbstractCard makeCopy() {
        AbstractShardCard c = new SapphireShard();
        c.BloodNum = BloodNum;
