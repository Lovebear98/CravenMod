...
@NoCompendium
public class ShardsofFate extends AbstractShardCard {
    public static final String[] EXTENDED_DESCRIPTION = CardStrings.getMockCardString().EXTENDED_DESCRIPTION;
    public static final String ID = makeID(ShardsofFate.class.getSimpleName());
    ...
    public AbstractCard makeCopy() {
        AbstractShardCard c = new ShardsofFate();
        c.BloodNum = BloodNum;
