...
import pathmaker.PathmakerMod;
import pathmaker.util.CardStats;
import pathmaker.util.TriFunction;
...
import static pathmaker.util.GeneralUtils.removePrefix;
import static pathmaker.util.TextureLoader.getCardTextureString;


public abstract class BaseCard extends CustomCard {
    final private static Map<String, DynamicVariable> customVars = new HashMap<>();

    protected static String makeID(String name) { return PathmakerMod.makeID(name); }
    ...
    public void upgrade()
    {
        if (!upgraded)
        {
            ...
            if (this.upgradesDescription)
            {
                ...
                {
                    PathmakerMod.logger.error("Card " + cardID + " upgrades description and has null upgrade description.");
                }
                else
                {
