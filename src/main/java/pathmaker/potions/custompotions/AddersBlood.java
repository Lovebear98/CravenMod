...
public class AddersBlood extends CustomPotion {

    public static final String POTION_ID = makeID(AddersBlood.class.getSimpleName());
    ...
    public AbstractPotion makeCopy() {
        AbstractPotion p = new AddersBlood();
        return p;
    }
}
