...
public class PowerFlower extends AbstractFlowerOrb {

    //Standard ID/Description
    public static final String ORB_ID = makeID(PowerFlower.class.getSimpleName());
    ...
    public PowerFlower() {
        super(ORB_ID, orbString.NAME, PASSIVE_AMOUNT, EVOKE_AMOUNT, DESCRIPTIONS[0], DESCRIPTIONS[0], OrbPath(PowerFlower.class.getSimpleName()));
