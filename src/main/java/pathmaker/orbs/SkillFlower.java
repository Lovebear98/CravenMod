...
public class SkillFlower extends AbstractFlowerOrb {

    //Standard ID/Description
    public static final String ORB_ID = makeID(SkillFlower.class.getSimpleName());
    ...
    public SkillFlower() {
        super(ORB_ID, orbString.NAME, PASSIVE_AMOUNT, EVOKE_AMOUNT, DESCRIPTIONS[0], DESCRIPTIONS[0], OrbPath(SkillFlower.class.getSimpleName()));
