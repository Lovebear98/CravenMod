...
public class OasisVigorPower extends BasePower implements CloneablePowerInterface, OasisReachedInterface {
    public static final String POWER_ID = makeID(OasisVigorPower.class.getSimpleName());
    ...
    public OasisVigorPower(AbstractCreature owner, int amount) {
    ...
    public AbstractPower makeCopy() {
        return new OasisVigorPower(owner, amount);
    }
