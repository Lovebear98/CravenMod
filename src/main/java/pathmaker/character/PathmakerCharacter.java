...
import pathmaker.cards.starter.Strike;
import pathmaker.cards.starter.Survive;
import pathmaker.cards.starter.Defend;
import pathmaker.cards.starter.Thrive;
import pathmaker.relics.PathmakerBadge;

import java.util.ArrayList;

import static pathmaker.PathmakerMod.characterPath;
import static pathmaker.PathmakerMod.makeID;
import static pathmaker.util.otherutil.SoundManager.GROWSOUNDKEY;

public class PathmakerCharacter extends CustomPlayer {
    //Stats
    ...
    //Strings
    private static final String ID = makeID(PathmakerCharacter.class.getSimpleName()); //This should match whatever you have in the CharacterStrings.json file
    ...
    public static class Meta {
        ...
        @SpireEnum
        public static PlayerClass PATHMAKER_CHARACTER;
        @SpireEnum(name = "SUNSAND GOLD") // These two MUST match. Change it to something unique for your character.
        public static AbstractCard.CardColor CARD_COLOR;
        @SpireEnum(name = "SUNSAND GOLD") @SuppressWarnings("unused")
        ...
        public static void registerCharacter() {
            BaseMod.addCharacter(new PathmakerCharacter(), CHAR_SELECT_BUTTON, CHAR_SELECT_PORTRAIT);
        }
    }
    ...
    public PathmakerCharacter() {
        super(getNames()[0], Meta.PATHMAKER_CHARACTER,
                new PathmakerOrb(), //Energy Orb
                new SpineAnimation(characterPath("animation/Svitasch.atlas"), characterPath("animation/Svitasch.json"), 1.45f)); //Animation
        ...
        initializeClass(null,
                ...
                CORPSE,
                getLoadout(),
                17.0F, -20.0F, 275.0F, 250.0F, //Character hitbox. x y position, then width and height.
    ...
    public ArrayList<String> getStartingDeck() {
        ...
        retVal.add(Thrive.ID);
        retVal.add(Thrive.ID);

        retVal.add(Survive.ID);
    ...
    public void doCharSelectScreenSelectEffect() {
        ...
        CardCrawlGame.sound.playA(GROWSOUNDKEY, MathUtils.random(-0.2F, 0.2F));
